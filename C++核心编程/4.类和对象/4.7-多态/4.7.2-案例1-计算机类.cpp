...
// 乘法计算器
class MulCalculator:public AbstractCalcultor{
public:
    int getResult(){
        return m_Num1 * m_Num2;
    }
...
void test02(){
    ...
    //创建加法计算器
    cout << "多态实现" << endl;
    AbstractCalcultor *abc = new AddCalculator;
    abc->m_Num1 = 10;
    abc->m_Num2 = 10;
    cout << abc->m_Num1<< " + " << abc->m_Num2 << " = "<< abc->getResult()<< endl;
    AbstractCalcultor *sub = new SubCalculator;
    sub->m_Num1 = 10;
    sub->m_Num2 = 10;
    cout << sub->m_Num1<< " - " << sub->m_Num2 << " = "<< sub->getResult()<< endl;
    AbstractCalcultor *mul = new MulCalculator;
    mul->m_Num1 = 10;
    mul->m_Num2 = 10;
